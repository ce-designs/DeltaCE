...
#define MAX_ATTENUATION 255		// max 255dB attuenation (other possible values are 255dB and 25.5dB)
#define	MIN_STEP_SIZE 1			// the lowest possible step size for attuenation of the audio signal
#define STEP_SIZE 1				// the desired step size (must be the same or a multiple of the minimum step size!)
